...
const libs = ['https://unpkg.com/vue@2.6.14/dist/vue.min.js',
              ...
              '../gc-maturity-chart/js/gc-maturity-chart.min.js'
            ];
...
function gcGetBaseURL() {
    ...
    let scriptURL = document.getElementById("gc-dashboard-harvest-init");
...
function initComponent() {
    ...
    */
    ...
    vmRoot = new Vue({
      ...
      i18n: i18n,
      created() {
        console.debug("gc-dashboard-harvest-init created!");
      ...
      watch: {
        ...
        currentTimeseries (newValue, oldValue) {
          console.debug("root currentTimeseries changed!");
        },
      ...
      methods: {
        ...
        getMaturityTimeseries: function () {

          console.debug("$root.getMaturityTimeseries()");

          let product = "maturity";

          const endpoint = "/parcels/" + this.selectedParcelId + "/" + product + "/timeseries"
          let params = "&order=date";
          if (this.dataSource.length > 0) {
            params = params + "&source=" + this.dataSource
          }
